...
def upload_to_sql(file_name=None):
    ...
    index_to_column_mapping = {
        0: 'consolid_recomed_number',
        1: 'consolid_all_pack_number',
        2: 'subpackage_number',
        3: 'lack_parcels_packing',
        4: 'workstation',
        5: 'operated_by',
        6: 'operation_time',
        7: 'warehouse',
    ...
    engine = get_engine()
    df.to_sql('packing', engine, if_exists='append', index=False)
    print("Dados inseridos com sucesso na tabela 'packing'.")
